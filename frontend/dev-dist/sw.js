...
define(['./workbox-25613826'], (function (workbox) { 'use strict';
  ...
  workbox.precacheAndRoute([{
    ...
    "url": "/",
    "revision": "0.h1jn4v2sr5c"
  }], {});
  workbox.cleanupOutdatedCaches();
  workbox.registerRoute(new workbox.NavigationRoute(workbox.createHandlerBoundToURL("/"), {
    allowlist: [/^\/$/]
  }));
  workbox.registerRoute(/^https:\/\/api\.iconify\.design\/.*/i, new workbox.CacheFirst({
  ...
  workbox.registerRoute(/^https:\/\/lh3\.googleusercontent\.com\/.*/i, new workbox.CacheFirst({
