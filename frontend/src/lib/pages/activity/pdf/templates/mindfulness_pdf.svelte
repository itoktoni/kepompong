...
{#if benefit}
  <div style="width:794px;height:{PAGE_H}px;box-sizing:border-box;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:64px;background:linear-gradient(135deg,#E8F5E9 0%,#fff 100%);font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif">
    <div style="font-size:64px;margin-bottom:20px">&#x1F31F;</div>
    <h2 style="font-size:28px;color:#2E7D32;font-weight:800;margin:0 0 24px">Manfaat</h2>
    <p style="font-size:22px;color:#1F2937;text-align:center;line-height:1.7;max-width:550px;font-weight:500;margin:0">{benefit}</p>
    <div style="margin-top:auto;padding-top:32px;font-size:11px;color:#9CA3AF">{APP_NAME}</div>
  </div>
{/if}
