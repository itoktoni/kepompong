...
<div class="px-margin-mobile md:px-margin-desktop pt-5 max-w-6xl mx-auto pb-8" bind:this={pullContainer}>
  ...
  {:else}
    <button onclick={() => history.back()}
      class="fixed bottom-22 right-4 lg:bottom-2 z-50 flex items-center gap-2 text-amber-100 font-label-lg hover:opacity-80 transition-opacity bg-primary px-4 py-2 rounded-full border-2 shadow-lg">
